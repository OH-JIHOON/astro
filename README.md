...
4. 초기 import는 JSON 파일 그대로 사용하고, import 이후 `Build Naver Request Body`, `Format Naver Data`, `Format Google Data`의 스크립트 수정은 n8n export JSON의 이스케이프 문자열로 인한 문법 오류를 피하기 위해 JSON 직접 편집 대신 n8n UI에서 진행합니다.
